...
k('t_faq_a8','Ano. Součástí sprintu je zmapování vašich AI use-casů, jejich zařazení podle rizikových kategorií AI Actu a nastavení pravidel a odpovědností tak, abyste byli připraveni na dotazy auditora i zákazníků. Nejsem právní kancelář — na finální právní výklad spolupracuji s vaším právníkem.',"Yes. The sprint includes mapping your AI use cases, classifying them under the AI Act risk categories, and setting rules and ownership so you're ready for auditors and customers. I'm not a law firm — for final legal interpretation I work with your counsel.",'Áno. Súčasťou šprintu je zmapovanie vašich AI use-casov, ich zaradenie podľa rizikových kategórií AI Actu a nastavenie pravidiel a zodpovedností tak, aby ste boli pripravení na otázky audítora aj zákazníkov. Nie som právna kancelária — na finálny právny výklad spolupracujem s vaším právnikom.','Ja. Der Sprint umfasst die Erfassung Ihrer KI-Use-Cases, ihre Einordnung nach den Risikokategorien des AI Act sowie das Festlegen von Regeln und Verantwortlichkeiten, damit Sie für Auditoren und Kunden gerüstet sind. Ich bin keine Kanzlei — für die endgültige rechtliche Auslegung arbeite ich mit Ihrem Anwalt zusammen.','Так. Спринт включає мапування ваших AI use-case-ів, їх класифікацію за категоріями ризику AI Act і встановлення правил та відповідальності, щоб ви були готові до запитань аудиторів і клієнтів. Я не юридична фірма — для остаточного правового тлумачення співпрацюю з вашим юристом.','نعم. يشمل السبرنت حصر حالات استخدام الذكاء الاصطناعي لديكم، وتصنيفها وفق فئات المخاطر في قانون الذكاء الاصطناعي، ووضع القواعد والمسؤوليات لتكونوا جاهزين لأسئلة المدققين والعملاء. لستُ مكتب محاماة — وللتفسير القانوني النهائي أتعاون مع مستشاركم القانوني.')
