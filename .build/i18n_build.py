...
# hero stats
# KPI pas 2026-07-21: fraze misto cisel. Zmenene/nove klice CZ only (en=CZ placeholder), preklady pozdeji.
k('t_stat1_v','Reální AI pracovníci','Reální AI pracovníci')
k('t_stat1_k','v produkci, ne pilot na hraní','v produkci, ne pilot na hraní')
k('t_stat2_v','1–3 priority','1–3 priorities')
k('t_stat2_k','nejvyšší návratnost, ne desítky experimentů','nejvyšší návratnost, ne desítky experimentů')
k('t_stat3_v','Jeden vlastník','Jeden vlastník')
k('t_stat3_k','jasná odpovědnost za každý systém','jasná odpovědnost za každý systém')
k('t_stat4_v','Měřený dopad','Measured impact')
k('t_stat4_k','board report, ne neurčité sliby','board report, ne neurčité sliby')
...
# bio: nova verze textu (2026-07-21). Zatim jen CZ — en pole = CZ placeholder (SK/DE/UK/AR fallback na en=CZ). Preklady pozdeji.
k('t_ab_p1','Pomáhám vedení firem převzít kontrolu nad AI: určit priority, nastavit governance, nasadit první AI pracovníky a měřit jejich skutečný dopad.','Pomáhám vedení firem převzít kontrolu nad AI: určit priority, nastavit governance, nasadit první AI pracovníky a měřit jejich skutečný dopad.')
k('t_ab_p2a','Nejsem prodejce nástrojů ani konzultant, který AI zná pouze z prezentací. AI systémy sám stavím, financuji a provozuji. Na platformě ','Nejsem prodejce nástrojů ani konzultant, který AI zná pouze z prezentací. AI systémy sám stavím, financuji a provozuji. Na platformě ')
k('t_ab_p2b',' nasazuji AI pracovníky do produkčního provozu. Ve venture studiu ',' nasazuji AI pracovníky do produkčního provozu. Ve venture studiu ')
k('t_ab_p2c',' ověřuji, které automatizované byznysy skutečně obstojí proti reálné poptávce a cashflow. ',' ověřuji, které automatizované byznysy skutečně obstojí proti reálné poptávce a cashflow. ')
k('t_ab_p2d',' je firma, jejíž akvizici zajišťuje tým autonomních AI agentů pod mým dohledem.',' je firma, jejíž akvizici zajišťuje tým autonomních AI agentů pod mým dohledem.')
k('t_ab_lab','Tato tři prostředí tvoří mou provozní laboratoř. Nejsem u tabule, jsem v zákopech — tam se pozná, co funguje a co je jen teorie. Ověřuji v nich technologii, ekonomiku i provozní model dřív, než něco doporučím klientovi. Vaši AI agendu proto nestavím na hype ani na prezentacích, ale na přístupech, které denně používám ve vlastních firmách a financuji vlastním kapitálem.','Tato tři prostředí tvoří mou provozní laboratoř. Nejsem u tabule, jsem v zákopech — tam se pozná, co funguje a co je jen teorie. Ověřuji v nich technologii, ekonomiku i provozní model dřív, než něco doporučím klientovi. Vaši AI agendu proto nestavím na hype ani na prezentacích, ale na přístupech, které denně používám ve vlastních firmách a financuji vlastním kapitálem.')
k('t_ab_p3','Jako fractional Head of AI zastupuji zájem vedení firmy, ne zájem dodavatele. Každá iniciativa musí prokázat návratnost, snížení rizika nebo jasný strategický přínos. Když čísla nevycházejí, doporučím projekt odložit nebo zastavit. Výsledkem jsou jasné priority, odpovědnost, měřitelné výstupy a board report místo neurčitých slibů.','Jako fractional Head of AI zastupuji zájem vedení firmy, ne zájem dodavatele. Každá iniciativa musí prokázat návratnost, snížení rizika nebo jasný strategický přínos. Když čísla nevycházejí, doporučím projekt odložit nebo zastavit. Výsledkem jsou jasné priority, odpovědnost, měřitelné výstupy a board report místo neurčitých slibů.')
k('t_ab_p4','Head of AI bude v příští dekádě klíčovou rolí pro řízení technologické změny ve firmách — a někdo za ni ve vaší firmě ponese odpovědnost. Jako bývalý armádní důstojník vím, že strategická výšina se obsazuje dřív, než se o ni začne bojovat. Proto na headofai.cz pomáhám firmám roli Head of AI obsadit včas — dřív, než jejich AI agendu začnou fakticky řídit dodavatelé, jednotliví zaměstnanci a nahodile zaváděné nástroje.','Head of AI bude v příští dekádě klíčovou rolí pro řízení technologické změny ve firmách — a někdo za ni ve vaší firmě ponese odpovědnost. Jako bývalý armádní důstojník vím, že strategická výšina se obsazuje dřív, než se o ni začne bojovat. Proto na headofai.cz pomáhám firmám roli Head of AI obsadit včas — dřív, než jejich AI agendu začnou fakticky řídit dodavatelé, jednotliví zaměstnanci a nahodile zaváděné nástroje.')
